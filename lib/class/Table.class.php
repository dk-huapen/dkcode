...
class dkTable {
	...
	protected $countsql;
	protected $conn;
	protected const host = "192.168.1.120";
	protected const username = "opcuasis";
	protected const password = "opcuasis";
	protected const database = "db_rekong";
	protected const charset = "set names utf8";
