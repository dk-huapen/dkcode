<html>
	<head>
    		<title>#1-#2号除渣系统</title>
		<?php include("../header.php")?>
	</head>
	<body>
		<?php include("top.php")?>
		<center><h1>#1-#2号除渣系统</h1></center>
		<script>
			var page = 251;
			var test =<?php
			include('../conn.php');
	...
	<!--SIS画面-->
		<svg width="1860" height="1000" viewBox="0 0 1860 1000" fill="gray">
			...
			?>
			<!--包含具体名称的元素-->
				<text x="300" y="85" fill="black" font-size="22" font-family="Arial">1号炉</text>
				<text x="300" y="535" fill="black" font-size="22" font-family="Arial">2号炉</text>
				<text x="1105" y="250" fill="black" font-size="22" font-family="Arial">1号斗提机</text>
				<text x="1285" y="250" fill="black" font-size="22" font-family="Arial">2号斗提机</text>
				<text x="1655" y="455" fill="black" font-size="22" font-family="Arial">1号渣库</text>
